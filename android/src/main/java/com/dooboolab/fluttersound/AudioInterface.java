...
interface AudioInterface {
  ...
  void recordAndRecognizeSpeech(boolean saveTempAudio, String langcode, boolean mute, MethodChannel.Result result);
  void stopRecognizeSpeech(boolean unmute, MethodChannel.Result result);
}
